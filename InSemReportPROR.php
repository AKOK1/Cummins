...
<form action="" method="post">
	<script>
		function sendtoatt() {
			...
			window.open('AllInsemMarksReportPROR.php?div=' + document.getElementById('ddldiv').value + '&year=' + document.getElementById('ddlYear').value + '&dept=' + document.getElementById('ddldept').value + '&deptname=' + subtext );
			return false;
