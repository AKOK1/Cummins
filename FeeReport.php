...
function sendtoreport()
{
	...
	window.open('FeeReport1.php?deptname=' + subtext + '&dept=' + subvalue + '&year=' + yeartext + '&feadmyear=' + acadyeartext);
	return false;
}
...
function sendtoreport2()
{
	...
	window.open('AdmReport2.php?deptname=' + subtext + '&dept=' + subvalue + '&year=' + yeartext + '&feadmyear=' + acadyeartext + '&divn=' + divtext);
	return false;
}
...
<div class="row-fluid">
<br/><br/><br/>
		<div style="float:left"><h3 class="page-title">Student Fee Report</h3></div>
		...
		<div style="float:left;margin-top:20px;margin-left:20px;">
			<input type="button" name="btnreport" value="View Student Report" class="btn btn btn-success" onclick="return sendtoreport();" />
		</div>
		...
		<div style="float:right"><h3 class='page-title' style='margin-right:30px;'><a href='FeeIndexMain.php'>Back</a></h3></div>
	</div>	
</body>	
</form>
