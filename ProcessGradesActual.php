...
<form action="" method="post">
	<script>
		function sendtoatt() {
			...
			window.open('GradeReport.php?year=' + document.getElementById('ddlYear').value + '&dept=' + document.getElementById('ddldept').value + '&deptname=' + subtext + '&acadyear=' + document.getElementById('ddlAcadYear').value);
	...
	<br /><br />
	<h3 class="page-title" style="margin-left:5%">Proces Exam Results</h3>
