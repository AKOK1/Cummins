	...
	include 'db/db_connect.php';
		...
		while($row=mysqli_fetch_array($run)){
			...
			echo "<table class='branch-table' style='width:100%;'>";
				...
				echo"<table class='branch-table' align='center' style='width:100%;'>";
					...
					echo"</table>";
		include 'db/db_connect.php';
			$query="SELECT examname,PaperCode AS subjectcode,sm.SubjectName, ys.papertype
					...
					WHERE  examname like '%Summer%' and yss.StdAdmID = ". $StdAdmID ." order by sm.SubjectName,em.ExamId ";
		...
		echo"<table class='branch-table' style='width:100%;'>";
			echo" <tr>";
			   ...
			   echo"</td>";
			   echo"<td style='width:25%;'><center>Exam Name</center>";
			   echo"</td>";
			   echo" <td style='width:15%;'><center>Subject Code</center>";
			   echo"</td>";
			   echo"<td style='width:25%;'><center>Subject Name</center>";
			   echo"</td>";
			...
			echo"</tr>";
				...
				while($row2=mysqli_fetch_array($run2)){
						...
						echo"<tr>";
							...
							echo"<td style='width:60px;'>$ename</td>";
