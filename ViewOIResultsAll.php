...
<body>
	...
	<TR>
		<td colspan='7' class='th-heading'><center>Online / In-sem Result</center></td>
	</TR>
	</table>
	<br/><br/>
...
?>
	...
	<?php
		...
		include 'db/db_connect.php';
		$sql = "SELECT CNUM,StdName,RollNo,Dept,`Div`,SeatNo," . $sublist . " FROM tbloiresults
