	<?php
		...
		?>		
<script>
				 function sendtoblock(profid) {
					window.location.href = 'assignblockMain.php?profid=' + profid;
				}
</script>
<form action="proflistMain.php" method="post">
	<br /><br />
	<div class="row-fluid">
		<div style="float:left"><h3 class="page-title">Examiner Assignment - <?php echo $_SESSION["SESSCAPSelectedExamName"]; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Professor List</h3></div>
					...
					if( $num_results ){
						...
						while( $row = $result->fetch_assoc() ){
							...
							echo "<td class='span2'>
										...
										onclick='javascript:sendtoblock({$userID});'>
