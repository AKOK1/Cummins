<html>
  ...
  <head>
    ...
    <title>Stationary Store Clerk</title>
	<style type="text/css">
...
?>
  <body>
    ...
    <br></br>
     Subject: Regarding appointment as a Stationary Store Clerk for University Theory Examination <?php echo $edit_record5;?>.
	...
	<p><!-- pagebreak --></p> 
         ...
         This is to inform you that you have been appointed as a Stationary Store Clerk for FE to BE University Theory Examination which will be held in <?php echo $edit_record5;?>.
<br>
		 Duty period is from <?php echo date("jS F Y",strtotime($edit_record6));?> to <?php echo date("jS F Y",strtotime($edit_record7));?>.
<br>
         You are requested to follow all the rules given by the Savitribai Phule Pune University.
<br><br></br></br>
        </p>
