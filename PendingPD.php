...
<body>
	...
	<TR>
		<td colspan='7' class='th-heading'><center>Personal Details Pending</center></td>
	</TR>
	</table>
	<br/><br/>
...
<table width="90%" border="0" cellpadding="5" cellspacing="0" class="fix-table" style="margin-left: 5%;">
	...
	<?php
		...
		$sql = "SELECT CNUM,CONCAT(COALESCE(FirstName,''),' ',COALESCE(Surname,'')) AS NAME,dept,mobno 
				FROM tblstudent WHERE COALESCE(Pmail,'') = '' AND CONCAT(COALESCE(FirstName,''),' ',COALESCE(Surname,'')) <> '';";
